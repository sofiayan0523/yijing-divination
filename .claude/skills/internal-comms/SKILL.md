...
name: internal-comms
description: >-
  A set of resources to help write all kinds of internal communications,
  using common corporate formats. Use this skill when asked to write internal
...
or more context about the desired format.
